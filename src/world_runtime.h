...
#include "enemies.h"
#include "npc.h"
typedef struct { MokoAmbient ambient; MokoEnemies enemies; int npc_nearby; int last_enemy_hit; uint8_t room_clear_rewarded[5]; int combat_notice_timer; int combat_notice_room; } MokoWorldRuntime;
