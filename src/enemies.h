...
#include <stdint.h>
typedef enum { ENEMY_TICKHOUND,ENEMY_RAINLING,ENEMY_SHADOW,ENEMY_GEARLING,ENEMY_WATCHER,ENEMY_HOUR_WARDEN,ENEMY_CHRONO_MITE,ENEMY_PENDULUM_WISP } MokoEnemyKind;
typedef struct { short x,y,home_x,home_y; signed char vx,vy; uint8_t room,kind,hp,active,phase,hit_cooldown; } MokoEnemy;
#define MOKO_ENEMY_COUNT 18
