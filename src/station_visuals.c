...
void station_visuals_draw(int tick,uint32_t *ot,char **p){int i,blink=(tick/28)&1;
 ...
 clock_face(ot,p,tick);tile(ot,p,3,111,137,102,16,31,36,47);line(ot,p,2,116,141,92,2,171,151,91);line(ot,p,2,124,146,76,2,80,105,113);
 ...
 bench(ot,p,22,173);bench(ot,p,249,173);poster(ot,p,88,133);poster(ot,p,211,133);lamp(ot,p,52,84,blink*12);lamp(ot,p,268,84,blink*12);lamp(ot,p,105,84,0);lamp(ot,p,215,84,0);
