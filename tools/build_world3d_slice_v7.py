...
# REV295 focuses on authored scene cohesion: moving village life, layered silhouettes,
# a readable plaza landmark and world-space encounter feedback. Everything is XYZ/GTE.
...
# Insert the authored life pass immediately after the road/foreground layers so it participates
# in the same camera and GTE transform as Moko, NPCs and enemies.
...
# Make Moko's face acknowledge travel direction, improving silhouette readability in 2.5D.
